...
from ecommerce.subscriptions.utils import get_subscription_from_basket_attribute
    ...
    def fulfill_product(self, order, lines, email_opt_in=False):
        ...
        for line in lines:
            ...
            try:
                ...
                logger.info('5065-enrollment_api_response: {} --- received after: {}'.format(response,time.time()))
