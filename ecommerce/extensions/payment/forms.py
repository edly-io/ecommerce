...
class CybersourceMicroformPaymentForm(forms.Form):
    ...
    This form captures the data necessary to complete a payment transaction with Cybersource microform.
    """
    ...
    def __init__(self, user, request, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Div(
                ...
                Div('', css_class='form-control', id='number-container'),
                HTML('<label for="securityCode-container">Security Code</label>'),
                Div('', css_class='form-control', id='securityCode-container'),
                css_class='form-item col-md-12'
            ),
            Div(
                Div('card_code', css_class='form-item col-md-4'),
